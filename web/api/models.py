...
SERIES = {
    ...
    "FRED-CRUDESTOCKS": ("WCESTUS1", "美国商业原油库存", "US commercial crude oil inventories"),
    "FRED-CRUDEPROD": ("MCRFPUS2", "美国原油产量", "US crude oil field production"),
    "FRED-REFINERYUTIL": ("WPULEUS3", "美国炼厂产能利用率", "US refinery utilization rate"),
