...
export const catalog = [
  ...
  row("FRED-CRUDESTOCKS", "A24ATI", "美国炼厂库存", "US petroleum refinery inventories", "库存与炼化", "百万美元", "月度", "#796c9d"),
  row("FRED-CRUDEPROD", "IPG21112N", "美国原油开采工业生产指数", "US industrial production: crude oil extraction", "供给与产能", "指数", "月度", "#5e8579"),
  row("FRED-REFINERYUTIL", "IPG32411S", "美国炼厂工业生产指数", "US industrial production: petroleum refineries", "库存与炼化", "指数", "月度", "#8a765f"),
  ...
  row("FRED-OVXCLS", "OVXCLS", "原油ETF隐含波动率指数", "CBOE Crude Oil ETF Volatility Index", "能源波动率", "指数", "日度", "#b65f48"),
  row("FRED-STLFSI4", "STLFSI4", "圣路易斯联储金融压力指数", "St. Louis Fed Financial Stress Index", "信用与流动性", "指数", "周度", "#765f83"),
  row("FRED-SP500", "SP500", "标普500指数", "S&P 500 index", "风险偏好", "指数", "日度", "#657f9a"),
  row("FRED-NASDAQCOM", "NASDAQCOM", "纳斯达克综合指数", "NASDAQ Composite Index", "风险偏好", "指数", "日度", "#526f98"),
  row("FRED-NASDAQXAU", "NASDAQXAU", "PHLX黄金与白银行业指数", "PHLX Gold/Silver Sector Index", "金融资产与避险", "指数", "日度", "#b58a42"),
  row("FRED-COPPER", "PCOPPUSDM", "全球铜价", "Global copper price", "工业品与替代资产", "美元/吨", "月度", "#a56f4f"),
  row("FRED-USEPUINDXD", "USEPUINDXD", "美国经济政策不确定性指数", "US Economic Policy Uncertainty Index", "地缘政治与事件风险", "指数", "日度", "#a76554"),
  row("FRED-DEXCHUS", "DEXCHUS", "美元兑人民币即期汇率", "China / U.S. foreign exchange rate", "汇率与跨境定价", "人民币/美元", "日度", "#507d78"),
  row("FRED-DFF", "DFF", "联邦基金有效利率（日度）", "Effective Federal Funds Rate", "货币与金融条件", "%", "日度", "#83739a"),
