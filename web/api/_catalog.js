...
export const catalog = [
  ...
  row("FRED-CRUDESTOCKS", "WCESTUS1", "美国商业原油库存", "US commercial crude oil inventories", "库存与炼化", "千桶", "周度", "#796c9d"),
  row("FRED-CRUDEPROD", "MCRFPUS2", "美国原油产量", "US crude oil field production", "供给与产能", "千桶/日", "月度", "#5e8579"),
  row("FRED-REFINERYUTIL", "WPULEUS3", "美国炼厂产能利用率", "US refinery utilization rate", "库存与炼化", "%", "周度", "#8a765f"),
